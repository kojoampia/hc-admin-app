...
import { sampleWithRequiredData } from '../care-activity.test-samples';
...
describe('CareActivity Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: CareActivity;
  let fixture: ComponentFixture<CareActivity>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CareActivity);
  ...
  it('should not fail on resource error state', async () => {
    ...
    expect(comp.careActivities()).toEqual([]);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.careActivitiesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });

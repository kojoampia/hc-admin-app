...
import { sampleWithRequiredData } from '../user-option.test-samples';
...
describe('UserOption Management Component', () => {
  ...
  let comp: UserOption;
  let fixture: ComponentFixture<UserOption>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(UserOption);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.userOptionsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });

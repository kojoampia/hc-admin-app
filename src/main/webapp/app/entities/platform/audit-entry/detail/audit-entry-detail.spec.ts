...
describe('AuditEntry Management Detail Component', () => {
  let comp: AuditEntryDetail;
  let fixture: ComponentFixture<AuditEntryDetail>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AuditEntryDetail);
    comp = fixture.componentInstance;
  });

  describe('OnInit', () => {
    it('should load auditEntry on init', async () => {

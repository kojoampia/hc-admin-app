...
describe('PlatformService Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: PlatformService;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PlatformService);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.platformServicesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
});

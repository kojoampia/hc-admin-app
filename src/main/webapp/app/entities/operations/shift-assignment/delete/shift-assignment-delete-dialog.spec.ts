...
import { ShiftAssignmentDeleteDialog } from './shift-assignment-delete-dialog';

describe('ShiftAssignment Management Delete Component', () => {
  let comp: ShiftAssignmentDeleteDialog;
  let fixture: ComponentFixture<ShiftAssignmentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ShiftAssignmentDeleteDialog);

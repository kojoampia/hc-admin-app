...
import { sampleWithRequiredData } from '../shift-assignment.test-samples';

import { ShiftAssignment } from './shift-assignment';

vitest.useFakeTimers();

describe('ShiftAssignment Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: ShiftAssignment;
  let fixture: ComponentFixture<ShiftAssignment>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ShiftAssignment);
  ...
  it('should not fail on resource error state', async () => {
    ...
    expect(comp.shiftAssignments()).toEqual([]);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.shiftAssignmentsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });

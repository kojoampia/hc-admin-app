...
import { RosterWeekDeleteDialog } from './roster-week-delete-dialog';

describe('RosterWeek Management Delete Component', () => {
  let comp: RosterWeekDeleteDialog;
  let fixture: ComponentFixture<RosterWeekDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RosterWeekDeleteDialog);

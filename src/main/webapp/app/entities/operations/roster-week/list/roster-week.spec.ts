...
import { sampleWithRequiredData } from '../roster-week.test-samples';
...
describe('RosterWeek Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: RosterWeek;
  let fixture: ComponentFixture<RosterWeek>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RosterWeek);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.rosterWeeksParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });

...
import { PlanFeatureDeleteDialog } from './plan-feature-delete-dialog';

describe('PlanFeature Management Delete Component', () => {
  let comp: PlanFeatureDeleteDialog;
  let fixture: ComponentFixture<PlanFeatureDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PlanFeatureDeleteDialog);

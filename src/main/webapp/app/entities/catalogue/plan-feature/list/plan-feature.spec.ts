...
import { sampleWithRequiredData } from '../plan-feature.test-samples';
...
describe('PlanFeature Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: PlanFeature;
  let fixture: ComponentFixture<PlanFeature>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PlanFeature);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.planFeaturesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });

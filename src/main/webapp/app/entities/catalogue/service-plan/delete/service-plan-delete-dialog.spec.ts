...
import { ServicePlanDeleteDialog } from './service-plan-delete-dialog';

describe('ServicePlan Management Delete Component', () => {
  let comp: ServicePlanDeleteDialog;
  let fixture: ComponentFixture<ServicePlanDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ServicePlanDeleteDialog);

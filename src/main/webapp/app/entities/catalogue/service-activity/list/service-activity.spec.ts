...
import { sampleWithRequiredData } from '../service-activity.test-samples';

import { ServiceActivity } from './service-activity';

vitest.useFakeTimers();

describe('ServiceActivity Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: ServiceActivity;
  let fixture: ComponentFixture<ServiceActivity>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ServiceActivity);
  ...
  it('should not fail on resource error state', async () => {
    ...
    expect(comp.serviceActivities()).toEqual([]);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.serviceActivitiesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });

...
import { sampleWithRequiredData } from '../angel.test-samples';
...
describe('Angel Management Component', () => {
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.angelsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });

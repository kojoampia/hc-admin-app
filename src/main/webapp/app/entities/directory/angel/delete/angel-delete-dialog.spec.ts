...
import { AngelDeleteDialog } from './angel-delete-dialog';

describe('Angel Management Delete Component', () => {
  let comp: AngelDeleteDialog;
  let fixture: ComponentFixture<AngelDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AngelDeleteDialog);

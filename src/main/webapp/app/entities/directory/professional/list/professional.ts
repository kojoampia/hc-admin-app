...
import { ProfessionalDeleteDialog } from '../delete/professional-delete-dialog';
...
export class Professional implements OnInit {
  ...
  delete(professional: IProfessional): void {
    const modalRef = this.modalService.open(ProfessionalDeleteDialog, { size: 'lg', backdrop: 'static' });
